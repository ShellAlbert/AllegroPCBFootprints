...
(putprop _clp_cinfo (list (_clpAdjustPt 0:0 _clp_cinfo)	
	(_clpAdjustPt 3:1.25 _clp_cinfo)) 'l_extents)
...
_clp_path = (_clpPathArcCenter _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 0.6708:1.25 _clp_cinfo) t
 	(_clpAdjustPt 1.500054144305308:-1.818989403545857e-016 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 2.3292:1.25 _clp_cinfo))
_clp_path = (_clpPathArcCenter _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
	_clp_cinfo->t_to_units) (_clpAdjustPt 3:0 _clp_cinfo) t
 	(_clpAdjustPt 1.499945855694692:0 _clp_cinfo))
_clp_path  = (_clpPathLine _clp_path (_clpMKSConvert 0.000000 _clp_cinfo->t_from_units
